 ...
 * @author pradeep
 */
public class SaleInfo extends javax.swing.JFrame {
Connection con = null;
Statement stmt = null;	
ResultSet rs = null;
    /**
    ...
    private void initComponents() {
        ...
        sale.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill_no", "Model", "Quantity", "Amount", "Discount", "NetAmount", "Remarks"
            }
        ));
        jScrollPane1.setViewportView(sale);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bill_no", "Model", "Quantity", "Amount", "Discount", "NetAmount", "Remarks" }));
        ...
        jTextField1.setFont(new java.awt.Font("Algerian", 0, 36)); // NOI18N
...
try{
          ...
          while(rs.next()){
              ...
              String nmt = rs.getString("Net_Amount");
              String rmk = rs.getString("Remarks");
              model.addRow(new Object[]{bn,md,qty,amt,dis,nmt,rmk});
          }
          rs.close();
          stmt.close();
          con.close();
...
try{
          ...
          stmt = con.createStatement();
          String sfld,op,crit;
          sfld = (String)jComboBox1.getSelectedItem();
          op = (String)jComboBox2.getSelectedItem();
          crit = (String)jTextField1.getText();         
          String query = "SELECT * FROM SALE where "+sfld+" "+op+ " '"+ crit + "';";
          rs = stmt.executeQuery(query); 
          while(rs.next()){
              String bn = rs.getString("Bill_no");
              String md = rs.getString("Model");
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaleInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
