...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        customerb = new javax.swing.JTable();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Customerb_Id", "Name", "Address", "Phone_no", "Category", "Date_of_birth", "Amount", "Discount", "Net_Amount", "Bill_no" }));
        ...
        customerb.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(customerb);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        jButton1.doClick();
        DefaultTableModel model = (DefaultTableModel) customerb.getModel();
        try{
            ...
            String query = "SELECT customerb_Id,Name,Address,Phone_no,Category,Date_of_bills,Amount,Discount,Net_Amount,Bill_no FROM customerb WHERE "+sfld+" "+op+" '"+crit+"';";
            rs = stmt.executeQuery(query);
            while(rs.next()) {
                model.addRow(new Object[ ] {
                    rs.getInt(1), rs.getString(2), rs.getString(3),
                    rs.getLong(4),  rs.getString(5), rs.getDate(6), rs.getInt(7), rs.getInt(8), rs.getLong(9), rs.getInt(10)
                });
            }
            rs.close();
            stmt.close();
...
dispose();
    ...
    private javax.swing.JTable customerb;
